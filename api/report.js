export default async function handler(req, res) {
  ...
  const { address, rooms, area, price, type, year, floor, outdoor, condition, insertText, parsedInsert, propertyKind, reportDate } = req.body;
...
- Wenn der Inseratstext eine Angabe macht (z.B. Zimmeranzahl), zitiere genau was dort steht — erfinde keine abweichenden Werte.
