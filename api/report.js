...
- ZIMMERANZAHL: Die einzige korrekte Zimmeranzahl ist ${rooms}. Schreibe diese Zahl genau so wie sie ist — keine Umformulierung, keine Interpretation. VERBOTEN: Jede andere Zahl als ${rooms} für die Zimmeranzahl zu verwenden.${parsedInsert?.zimmer && parsedInsert.zimmer !== parseFloat(rooms) ? ` HINWEIS: Das Inserat nennt ${parsedInsert.zimmer} Zimmer, das Formular ${rooms} — schreibe: "Zimmeranzahl-Widerspruch: Formular zeigt ${rooms}, Inserat ${parsedInsert.zimmer} Zimmer — unbedingt klären."` : ' Wenn du im Inseratstext eine andere Zimmeranzahl siehst, ignoriere sie — das Formular ist massgebend.'}
- BAUJAHR: Das einzige korrekte Baujahr ist ${year}. VERBOTEN: Jedes andere Baujahr zu nennen ausser ${year}, es sei denn du zitierst explizit den Inseratstext als Quelle.
