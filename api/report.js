        ...
        try {
          ...
          if (isPng) {
            ...
            if (idatData.length > 0) {
              ...
              // Map BAFU color to dB (EU noise directive color scheme)
              // Transparent/white = no data
              if (a < 50 || (r > 240 && g > 240 && b > 240)) {
                noiseDay = 35;
                noiseSource = 'BAFU (ruhige Lage, kein Strassenlaerm)';
                console.log('BAFU NOISE: transparent/white = quiet');
              } else if (g > 150 && r < 150 && b < 100) {
                // Green: < 55 dB
                noiseDay = 50; noiseSource = 'BAFU Strassenlaerm';
              } else if (r > 200 && g > 200 && b < 80) {
                // Yellow: 55-60 dB
                noiseDay = 57; noiseSource = 'BAFU Strassenlaerm';
              } else if (r > 220 && g > 120 && g < 180 && b < 80) {
                // Orange: 60-65 dB
                noiseDay = 62; noiseSource = 'BAFU Strassenlaerm';
              } else if (r > 200 && g < 80 && b < 80) {
                // Red: 65-70 dB
                noiseDay = 67; noiseSource = 'BAFU Strassenlaerm';
              } else if (r > 120 && r < 200 && g < 30 && b < 30) {
                // Dark red: > 70 dB
                noiseDay = 73; noiseSource = 'BAFU Strassenlaerm';
              } else {
                console.log('BAFU NOISE: unknown color RGB', r, g, b, '- using OSM fallback');
              }
