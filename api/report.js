...
- ZIMMERANZAHL: Es sind EXAKT ${rooms} Zimmer. Diese Zahl steht im Formular und ist verbindlich. Nenne im gesamten Report NUR diese Zahl. Wenn der Inseratstext abweicht, schreibe: "Laut Formular ${rooms} Zimmer (Inseratstext nennt X Zimmer — bitte prüfen)." Erfinde keine eigene Zahl.
- BAUJAHR: Laut Formular ${year}. Wenn der Inseratstext abweicht, beide zitieren. Kein drittes Baujahr erfinden.
- INSERATSTEXT: Kommentiere NUR was explizit darin steht. Leite NICHTS ab was nicht wörtlich erwähnt wird. Wenn der Text abbricht oder unvollständig wirkt, erwähne das NICHT — das ist ein technisches Artefakt, kein Mangel des Inserats.
- HALLUZINATIONSVERBOT: Erfinde keine Fakten, Ausstattungsmerkmale, Bewertungen oder Einschätzungen die nicht in den Daten oder im Inseratstext stehen. "Nicht verfügbar" ist besser als eine Erfindung.
...
${taxBurdenCHF ? (() => {
    ...
    const taxLabel = np <= 5  ? 'ausgesprochen tief ★★★★★ — Top 5% günstigste Gemeinden der Schweiz' :
                    np <= 20  ? 'tief ★★★★ — günstig im nationalen Vergleich' :
                    np <= 45  ? 'moderat ★★★ — leicht unter Schweizer Durchschnitt' :
...
Nationaler Vergleich: günstiger als ${100-np}% aller Schweizer Gemeinden.
Profil: ledig, steuerbares Einkommen CHF 120'000, ohne Kirchensteuer. Quelle: ESTV 2025, Profil: ledig, CHF 150'000 Bruttoeinkommen, ohne Kirchensteuer.`;
    } else {
      return `
${s.taxSection}
