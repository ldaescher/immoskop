  ...
  if (solarResult.status === 'fulfilled') {
    try {
      ...
      if (results.length) {
        ...
        const val = props.gstrahlung || props.jahresertrag || props.klasse || null;
        console.log('SOLAR field picked:', {gstrahlung:props.gstrahlung, jahresertrag:props.jahresertrag, klasse:props.klasse, allKeys:Object.keys(props).join(',')});
