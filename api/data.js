export default async function handler(req, res) {
  ...
  return res.status(200).json({
    meta: {
      ...
      crime, steuerfuss, estvTotal, estvNatPctVal, estvKtPctVal, estvKanton, taxBurdenCHF, taxBurdenPct, estvKanton, estvNatPctVal, estvKtPctVal, estvBfsnr, taxBurdenSource, delta, expected, priceRangeText, priceSource,
